pub mod prelude {
    ...
    pub use super::{ConstantDrawableFlagSet, ConstantDrawableFlags};
    pub use super::{DynamicDrawableFlagSet, DynamicDrawableFlags};
}
...
use super::base_types::{DrawableIndex, TextureIndex};
